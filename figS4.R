...
predictor_specs <- list(list(id = "impervious_1000", formula_var = "impervious_1000",   effect_var = "impervious.1000"),
                        list(id = "impervious_500", formula_var = "impervious_500",   effect_var = "impervious.500"),
                        list(id = "impervious_150", formula_var = "impervious_150",   effect_var = "impervious.150"))
...
sem_eff <- bind_rows(effect_tables) %>%
  ...
  mutate(predictor = recode(predictor,
                            ...
                            impervious.500 = "% impervious\n(500 m)",
                            impervious.150 = "% impervious\n(150 m)")) %>%
